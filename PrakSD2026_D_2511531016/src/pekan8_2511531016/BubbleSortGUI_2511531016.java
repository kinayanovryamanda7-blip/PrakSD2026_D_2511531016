...
import pekan8_2511531016.BubbleSortGUI_2511531016;

public class BubbleSortGUI_2511531016 extends JFrame {
	 ...
	 * Create the frame.
	 */
	public BubbleSortGUI_2511531016() {
	...
	private void setArrayFromInput_1016() {
	    ...
	    for (int k_1016 = 0; k_1016 < array_1016.length; k_1016++) {
	        ...
	        labelArray_1016[k_1016].setOpaque(true);
	        labelArray_1016[k_1016].setBackground(Color.WHITE);
	...
	private void performStep_1016() {
	    if (!sorting_1016 || i_1016 >= array_1016.length - 1) {
	        sorting_1016 = false;
	        stepButton_1016.setEnabled(false);
	    ...
	    labelArray_1016[j_1016 + 1].setBackground(Color.CYAN);
	    if (array_1016[j_1016] > array_1016[j_1016 + 1]) {
	        // swap
	        int temp_1016 = array_1016[j_1016];
	        array_1016[j_1016] = array_1016[j_1016 + 1];
	        array_1016[j_1016 + 1] = temp_1016;
	        labelArray_1016[j_1016].setBackground(Color.RED);
	        labelArray_1016[j_1016 + 1].setBackground(Color.RED);

	        stepLog.append("Langkah ").append(stepCount_1016)
	               .append(": Menukar elemen ke-")
	               .append(j_1016).append(" [")
	               .append(array_1016[j_1016 + 1]).append("] dengan ke-")
	               .append(j_1016 + 1).append(" [")
	               .append(array_1016[j_1016]).append("]\n");
	    } else {
	        stepLog.append("Langkah ").append(stepCount_1016)
	               .append(": Tidak ada pertukaran antara ke-")
	               .append(j_1016).append(" dan ke-")
	               .append(j_1016 + 1).append("\n");
	    }

	    stepLog.append("Hasil: ")
	           .append(arrayToString_1016(array_1016))
	           .append("\n\n");
	    stepArea_1016.append(stepLog.toString());
	    updateLabels_1016();
	    j_1016++;

	    if (j_1016 >= array_1016.length - i_1016 - 1) {
	        j_1016 = 0;
	        i_1016++;
	    }
	    stepCount_1016++;

	    if (i_1016 >= array_1016.length - 1) {
	        sorting_1016 = false;
	        stepButton_1016.setEnabled(false);
	        JOptionPane.showMessageDialog(this, "Sorting selesai!");
	    }
	...
	public static void main(String[] args) {
	    SwingUtilities.invokeLater(() -> {
	        BubbleSortGUI_2511531016 gui_1016 = new BubbleSortGUI_2511531016();
